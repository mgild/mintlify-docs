...
flowchart TB
    ...
    Step1[1. Get best order from PropAMM, CLMM, Limit] --> Step2
    Step2[2. Select source with best price] --> Step3
    Step3[3. Fill from that source] --> Step4
    Step4[4. Update totals] --> Start
...
Crankers are incentivized via protocol rewards (TODO).
