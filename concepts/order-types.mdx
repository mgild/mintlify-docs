...
```mermaid
graph LR
    subgraph spread["Effective Spread Comparison"]
        SpreadSpacer[ ]
        L["Limit Order: 1bp spread + 20bp fee = <b>21bp</b>"]
        C["CLMM Order: 1bp spread + 30bp fee = <b>31bp</b>"]
        P["PropAMM: 1bp spread + 0bp fee = <b>1bp</b>"]
    end
    style SpreadSpacer fill:none,stroke:none
    style L fill:#21252b,stroke:#61afef,color:#abb2bf
    style C fill:#21252b,stroke:#c678dd,color:#abb2bf
    style P fill:#21252b,stroke:#98c379,color:#abb2bf
```
...
```mermaid
flowchart LR
    subgraph timeline["PropAMM Timeline"]
        TimelineSpacer[ ]
        S["Slot N"] --> O["Order placed<br/>(0 fees)"]
        O --> V["Valid ~400ms"]
        V --> E["Expires"]
    end
    style TimelineSpacer fill:none,stroke:none
    style S fill:#21252b,stroke:#e5c07b,color:#abb2bf
    style O fill:#21252b,stroke:#98c379,color:#abb2bf
    style V fill:#21252b,stroke:#61afef,color:#abb2bf
    style E fill:#21252b,stroke:#e06c75,color:#abb2bf
```
